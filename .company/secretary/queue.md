...
- [ ] Next high-turnover cycle should either integrate the surviving `M5 long ret24` branch with the new `M15 short gap` branch, or find one more positive branch before discussing live promotion.
