...
RUN_ID='ts15j_post_shock_excursion_r2_202503'
JOURNAL=Path.home()/'AppData/Roaming/MetaQuotes/Tester/D232275B22422903BD477FB48B858FBA/Agent-127.0.0.1-3000/logs/20260902.log'
...
def main():
    ...
    if not starts:raise RuntimeError('formal Step15J journal segment not found')
