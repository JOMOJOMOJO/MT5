...
- Test volume/Magic: 0.01 / 26082514
...
| expert time-close operation identity | OBSERVED_PASS | exit request differs from entry request and matches DEAL_ORDER for Long/Short |
