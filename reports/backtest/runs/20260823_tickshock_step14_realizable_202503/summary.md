...
- Formal edge eligibility: NO (fail-closed run integrity)
...
| runtime seconds | 372.797 |
| average / max memory MB | 10.000 / 10 |
| events.csv bytes | 5149476 |
| summary.csv bytes | 207602 |
| trade.csv rows / bytes | 0 / 15 |
| formal validation violations | 4 |
