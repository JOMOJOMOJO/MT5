...
$variants = @(
    @{Name="f1"; Label="v2_4_h15_r120_cd4"; Hold="15"; R="1.20"; Cool="4"; Open="2"; Risk="5.0"; Magic="2026052121"},
    @{Name="f2"; Label="v2_4_h15_r115_cd4"; Hold="15"; R="1.15"; Cool="4"; Open="2"; Risk="5.0"; Magic="2026052122"},
    @{Name="f3"; Label="v2_4_h12_r115_cd3"; Hold="12"; R="1.15"; Cool="3"; Open="2"; Risk="5.0"; Magic="2026052123"},
    @{Name="f4"; Label="v2_4_stack3_h15_r115_cd3"; Hold="15"; R="1.15"; Cool="3"; Open="3"; Risk="5.0"; Magic="2026052124"}
)
...
$results | Export-Csv -LiteralPath (Join-Path $runRoot "fast_exit_summary.csv") -NoTypeInformation
