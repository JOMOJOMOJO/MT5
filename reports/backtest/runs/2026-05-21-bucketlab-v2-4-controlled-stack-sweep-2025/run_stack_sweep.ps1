...
$variants = @(
    @{Name="s3a"; Hold="25"; R="1.20"; Cool="4"; MaxOpen="3"; Risk="5.0"; Magic="2026052111"; Label="v2_4_stack3_h25_r120_cd4_risk5"},
    @{Name="s3b"; Hold="20"; R="1.20"; Cool="4"; MaxOpen="3"; Risk="5.0"; Magic="2026052112"; Label="v2_4_stack3_h20_r120_cd4_risk5"},
    @{Name="s3c"; Hold="25"; R="1.25"; Cool="6"; MaxOpen="3"; Risk="5.0"; Magic="2026052113"; Label="v2_4_stack3_h25_r125_cd6_risk5"},
    @{Name="s3d"; Hold="25"; R="1.20"; Cool="4"; MaxOpen="3"; Risk="4.0"; Magic="2026052114"; Label="v2_4_stack3_h25_r120_cd4_risk4"}
)
...
foreach($variant in $variants) {
    ...
    Set-PresetValue $lines "InpMaxOpenPositions" $variant.MaxOpen
...
$results | Export-Csv -LiteralPath (Join-Path $runRoot "stack_sweep_summary.csv") -NoTypeInformation
