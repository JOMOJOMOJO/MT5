...
- REALIZABLE events.csv: 5149590 bytes / 19 rows
- REALIZABLE summary.csv: 214281 bytes / 1184 rows
- trade CSV: 0 rows / 15 bytes; research EA sent no orders
- runtime: IDEAL 353.297 seconds; REALIZABLE 351.390 seconds
...
- structured REALIZABLE CSV volume: 5366218 bytes/month; linear estimate 64394616 bytes/year and 193183848 bytes/three years if event density and schema stay similar
- retaining both modes would approximately double structured CSV volume to 128789232 bytes/year
...
- `reports/backtest/runs/20260822_tickshock_causal_realizable_202503/summary.md`
- `reports/backtest/runs/20260822_tickshock_causal_realizable_202503/events.csv`
- `reports/backtest/runs/20260822_tickshock_causal_realizable_202503/summary.csv`
- `reports/backtest/runs/20260822_tickshock_causal_realizable_202503/reconciliation.md`
- `reports/backtest/runs/20260822_tickshock_causal_comparison_202503/comparison.csv`
- `reports/backtest/runs/20260822_tickshock_causal_comparison_202503/causal_invariants.csv`
- `reports/backtest/runs/20260822_tickshock_causal_comparison_202503/summary.md`
