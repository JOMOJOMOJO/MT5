...
- Formal analysis eligibility: NO (ideal event-time diagnostic only)
...
| runtime seconds | 372.781 |
| average / max memory MB | 10.000 / 10 |
| events.csv bytes | 5153994 |
| summary.csv bytes | 220239 |
...
|---|---|---|---|---|
| 162 | 276.160 | 268.000 | 466.000 | 0.290 |
