...
$variants = @(
    @{Name="sh1"; Label="v2_5_shallow_score610"; Score="6.10"; Up="0.62"; Down="0.38"; RangeMax="0.92"; Magic="2026052132"},
    @{Name="sh2"; Label="v2_5_shallow_pressure6040"; Score="6.20"; Up="0.60"; Down="0.40"; RangeMax="0.92"; Magic="2026052133"},
    @{Name="sh3"; Label="v2_5_shallow_range098"; Score="6.20"; Up="0.62"; Down="0.38"; RangeMax="0.98"; Magic="2026052134"}
)
...
foreach($variant in $variants) {
    ...
    Set-PresetValue $lines "InpShallowScoreThreshold" $variant.Score
...
$results | Export-Csv -LiteralPath (Join-Path $PSScriptRoot "shallow_sensitivity_summary.csv") -NoTypeInformation
