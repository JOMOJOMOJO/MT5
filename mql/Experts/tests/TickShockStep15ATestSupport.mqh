...
void TS15ARunCase(const string id)
  {
   ...
   if(id=="TS15A-RET-001")
     ...
     {
      TickShockV1Diagnostics d;TSV1SeparateDiagnostics(true,0.10,1.0,1.0,2.0,d);
      TS5AddBool(a,"statistical_recorded",d.statistical_shock);
      TS5AddBool(a,"strategy_event_allocated",TSV1StrategyPathEligible(d));
     }
