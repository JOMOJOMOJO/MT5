//+------------------------------------------------------------------+
//| BTCUSD Intrabar Reversal Prototype                              |
//+------------------------------------------------------------------+
#property copyright   "Trading System"
#property link        "https://www.mql5.com"
#property version     "1.00"
#property strict
#property description "BTCUSD M5 intrabar reversal family with late downside-followthrough longs and NY close-location shorts"
...
input int             InpLongRuleMode               = LongRuleBreakoutFollowthroughDown;
...
input long            InpMagicNumber               = 20260441;
...
int OnInit()
  {
   ...
   if(InpMagicNumber <= 0 || InpATRPeriod <= 0 || InpRiskPercent <= 0.0 ||
      ...
      InpLongRuleMode < LongRuleEmaGap2050 || InpLongRuleMode > LongRuleBreakoutFollowthroughDown ||
...
bool LoadSignalContext(SignalContext &ctx)
  {
   ...
   if(tickFlowSigned3 == DBL_MAX || closeLocation == DBL_MAX || rangeCompression12 == DBL_MAX ||
      ...
      breakoutPersistDown6 == DBL_MAX || breakoutFollowthroughDown == DBL_MAX || tickVolumeZ == DBL_MAX)
      return false;
