...
& powershell -ExecutionPolicy Bypass -File $closeScriptPath `
    ...
    -BaselineSummaryPath "reports/telemetry/2026-04-02-usdjpy-quality12b-guarded-baseline.json" `
    -RunLabel $RunLabel `
    -ForwardLabel "usdjpy_20260402_round_continuation_long_quality12b_guarded" `
