param(
    ...
    [ValidateSet("Original", "RegimeComparison", "ScanIntervalComparison", "WaveAudit", "V2Comparison")]
...
function Write-ThirdWavePreset {
    ...
    foreach ($line in $lines) {
        ...
        if ($line -match '^InpResearchStrategyMode=') {
            $out.Add("InpResearchStrategyMode=$($Run.StrategyMode)||$($Run.StrategyMode)||0||3||N")
