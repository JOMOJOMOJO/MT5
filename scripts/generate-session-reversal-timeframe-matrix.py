...
TIMEFRAME_CONFIGS = [
    {
        ...
        "allow_structure_trend_bias_when_no_wave3": False,
    ...
    {
        "timeframe_config_id": "h1_m30_m5_strict",
        "short": "h1_m30_m5_strict",
        "top_context_tf": "PERIOD_H1",
        "top_context_tf_value": 60,
        "structure_tf": "PERIOD_M30",
        "structure_tf_value": 30,
        "primary_entry_tf": "PERIOD_M5",
        "primary_entry_tf_value": 5,
        "secondary_entry_tf": "PERIOD_M5",
        "secondary_entry_tf_value": 5,
    ...
    {
        "timeframe_config_id": "h1_m30_m5_top_opposite_only",
        "short": "h1_m30_m5_top_notopp",
        "top_context_tf": "PERIOD_H1",
        "top_context_tf_value": 60,
        "structure_tf": "PERIOD_M30",
        "structure_tf_value": 30,
        ...
        "htf_permission_mode": "structure_confirmed_top_not_opposite_pre_filter",
        "htf_permission_value": 1,
        "allow_structure_trend_bias_when_no_wave3": True,
        "use_fib_pullback_score": False,
        "require_fib_pullback_zone": False,
    },
    {
...
def preset_text(run, magic):
    return "\n".join([
        ...
        f"InpAllowStructureTrendBiasWhenNoWave3={b(run['allow_structure_trend_bias_when_no_wave3'])}",
