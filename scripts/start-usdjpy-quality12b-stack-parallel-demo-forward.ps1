...
& powershell -ExecutionPolicy Bypass -File $startScriptPath `
    -BasePresetPath "reports/presets/usdjpy_20260402_round_continuation_long-quality12b_stack_parallel_guarded.set" `
    -RunLabel $RunLabel `
    ...
    -TelemetryFilePrefix "mt5_company_usdjpy_20260402_round_continuation_long_quality12b_stack_parallel_guarded" `
    -ChartSymbol "USDJPY" `
    -ChartTimeframe "M15"
