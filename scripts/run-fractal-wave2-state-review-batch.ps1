param(
    ...
    [string]$MatrixPath = "reports\backtest\runs\20260714_fractal_wave2_transition_state_review\run_matrix.csv",
    [string]$RunRootPath = "reports\backtest\runs\20260714_fractal_wave2_transition_state_review",
...
Log "Starting fractal wave2 state review batch. selected=$($selected.Count) terminal=$TerminalPath"
