...
RUN_ROOT = BACKTEST / "runs" / "20260708_session_reversal_m15_wave1_quality"
...
BASE_VARIANTS = [
    ...
    ("wave1_diag", "wave1_quality_diagnostic_only", {
        "InpUseM5CorrectiveABC": "false",
        "InpM5CorrectiveMode": "0",
        "InpUseM15Wave1Quality": "true",
        "InpM15Wave1QualityMode": "1",
    }),
    ("light_and_wave1", "required_light_and_wave1_quality", {
        "InpM15WaveContextMode": "3",
        "InpUseM5CorrectiveABC": "true",
        "InpM5CorrectiveMode": "2",
        "InpUseM15Wave1Quality": "true",
        "InpM15Wave1QualityMode": "3",
        "InpM15Wave1QualityCombineMode": "1",
    }),
    ("light_or_wave1", "required_light_or_wave1_quality", {
        **M15_DIAG_BASE,
        "InpUseM15Wave1Quality": "true",
        "InpM15Wave1QualityMode": "3",
        "InpM15Wave1QualityCombineMode": "2",
    }),
    ("wave1_only", "wave1_quality_required_only", {
        "InpM15WaveContextMode": "1",
        "InpM15Wave2ExpansionMode": "6",
        "InpM15Wave2GateMode": "5",
        "InpM15Wave2AdjacentMode": "9",
    ...
    ("light_or_wave1_exhaustion", "required_light_plus_wave1_quality_nearmiss", {
        **M15_DIAG_BASE,
        "InpUseM15Wave1Quality": "true",
        "InpM15Wave1QualityMode": "3",
        "InpM15Wave1QualityCombineMode": "3",
    }),
    ("one_light_wave1_diag", "one_symbol_required_light_wave1_quality", {
        "InpScenarioMode": "1",
        "InpM15WaveContextMode": "3",
        "InpUseM5CorrectiveABC": "true",
        "InpM5CorrectiveMode": "2",
    ...
    ("one_light_or_wave1", "one_symbol_required_light_or_wave1_quality", {
        **M15_DIAG_BASE,
        "InpScenarioMode": "1",
        "InpUseM15Wave1Quality": "true",
        "InpM15Wave1QualityMode": "3",
    ...
    ("one_wave1_only", "one_symbol_wave1_quality_required_only", {
        "InpScenarioMode": "1",
        "InpM15WaveContextMode": "1",
        "InpM15Wave2ExpansionMode": "6",
        "InpM15Wave2GateMode": "5",
...
def inputs_for(run, magic):
    ...
    values["InpLogFolder"] = f"fx_session_reversal_m15_wave1_quality_{run[0]}"
...
def main():
    ...
    for index, run in enumerate(build_runs(args.phase), start=1):
        ...
        magic = 202607081200 + index
        preset_name = f"{EA_NAME}_wave1q_{run_id}.set"
        ini_name = f"{EA_NAME}_wave1q_{run_id}.ini"
        ...
        for key in [
            ...
            "InpM15Wave1MinImpulseAtr", "InpM15Wave1MinBodyEfficiency", "InpM15Wave1MaxOverlapRatio", "InpM15Wave1MaxAgeBars",
