...
RUN_ROOT = BACKTEST / "runs" / "20260703_session_reversal_m15_wave2_expansion_mfe_lift"
...
VARIANTS = [
    ("base", "baseline_c10", {"InpUseM5CorrectiveABC": "false", "InpM5CorrectiveMode": "0"}),
    ("light", "m15_wave2_required_light_baseline", {"InpM15WaveContextMode": "3", "InpUseM5CorrectiveABC": "true", "InpM5CorrectiveMode": "2"}),
    ("expanded", "m15_wave2_required_expanded", {"InpM15Wave2ExpansionMode": "2", "InpM15Wave2GateMode": "2"}),
    ("wave1or2", "m15_wave2_wave1_or_wave2_context", {"InpM15Wave2ExpansionMode": "3", "InpM15Wave2GateMode": "2"}),
    ("notopp", "m15_structure_not_opposite_plus_pullback", {"InpM15Wave2ExpansionMode": "4", "InpM15Wave2GateMode": "2"}),
    ("fibstruct", "m15_fib_or_structure_pullback", {"InpM15Wave2ExpansionMode": "5", "InpM15Wave2GateMode": "2"}),
    ("lowqual", "m15_wave2_required_only_for_low_quality_m5", {"InpM15Wave2ExpansionMode": "3", "InpM15Wave2GateMode": "3"}),
    ("medlowqual", "m15_wave2_required_for_medium_low_quality_m5", {"InpM15Wave2ExpansionMode": "3", "InpM15Wave2GateMode": "6"}),
    ("onesym_expanded", "one_symbol_m15_wave2_expanded", {"InpScenarioMode": "1", "InpM15Wave2ExpansionMode": "2", "InpM15Wave2GateMode": "2"}),
    ("onesym_quality", "one_symbol_m15_wave2_quality_gate", {"InpScenarioMode": "1", "InpM15Wave2ExpansionMode": "3", "InpM15Wave2GateMode": "3"}),
    ("nosess_expdiag", "no_session_gate_m15_wave2_expanded_diagnostic", {"InpSessionGateMode": "1", "InpM15Wave2ExpansionMode": "6", "InpM15Wave2GateMode": "5"}),
    ("expanded_fixed_exit", "m15_wave2_expanded_fixed_tp_sl_only", {"InpM15Wave2ExpansionMode": "2", "InpM15Wave2GateMode": "2", "InpExitMode": "0", "InpTranscriptUsePrimaryFailureExit": "false"}),
    ("expanded_short_hold", "m15_wave2_expanded_shorter_hold_diagnostic", {"InpM15Wave2ExpansionMode": "2", "InpM15Wave2GateMode": "2", "InpExitMode": "3", "InpMaxHoldBars": "18"}),
]


SESSION_REFERENCES = [
    ("one_base", "one_symbol_first120", 1, "session_reversal_pullback_one_symbol_first120", {}),
    ("tky_base", "tokyo_first120_reference", 5, "tokyo_first120_reference", {}),
    ("ldn_base", "london_first120_reference", 6, "london_first120_reference", {}),
    ("ny_base", "newyork_first120_reference", 7, "newyork_first120_reference", {}),
    ("clean_base", "clean_target_path_first120", 3, "session_reversal_pullback_clean_target_path_first120", {}),
]
...
def build_runs():
    ...
    for short, name, mode, scenario_name, values in SESSION_REFERENCES:
        scenario_key, _, _ = scenario_from_values({"InpScenarioMode": str(mode)})
        runs.append((f"full2025_{short}", "full2025_validation", scenario_key, mode, scenario_name, "2025.01.01", "2025.12.31", short, name, values))
    return runs
...
def inputs_for(run, magic):
    ...
    values["InpLogFolder"] = f"fx_session_reversal_m15wave2_{run[0]}"
...
def tester_ini(run, preset_name):
    ...
    return "\n".join([
        "; M15 wave2 expansion and MFE lift validation.",
        "",
        "[Experts]",
        "Enabled=0",
        "AllowLiveTrading=0",
...
def main():
    ...
    for index, run in enumerate(build_runs(), start=1):
        ...
        for key in [
            ...
            "InpM15Wave2ExpansionMode", "InpM15Wave2GateMode", "InpExitMode", "InpMaxHoldBars",
        ]:
            row[key] = values[key]
        rows.append(row)
