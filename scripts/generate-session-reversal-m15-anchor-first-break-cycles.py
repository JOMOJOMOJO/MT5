...
RUN_ROOT = BACKTEST / "runs" / "20260710_session_reversal_m15_anchor_first_break_pullback"
...
DEFAULTS = {
    ...
    "InpUseTruePostAnchorBreakPullback": "false",
    "InpPostAnchorPullbackMode": "0",
    "InpPostAnchorPullbackTF": "5",
    "InpPostAnchorPullbackMaxBars": "24",
    "InpPostAnchorPullbackMinBars": "1",
    "InpPostAnchorRetestMaxDistanceAtr": "0.25",
    "InpPostAnchorAllowCloseBackInsideAtr": "0.10",
    "InpPostAnchorRequireM5Reconfirm": "true",
    "InpExitMode": "1",
...
VARIANTS = [
    ...
    ("anchor_diag_first_break", "anchor_diag_first_break", ANCHOR_DIAG),
    ("anchor_flip_first_break", "anchor_flip_first_break_required", {**ANCHOR_DIAG, "InpM15SwingAnchorMode": "4"}),
    ("anchor_flip_first_break_fresh", "anchor_flip_first_break_fresh_required", {
        **ANCHOR_DIAG,
        "InpM15SwingAnchorMode": "4",
        "InpM15BiasFlipMaxAgeBars": "12",
    }),
    ("anchor_pullback_diag", "anchor_flip_true_pullback_diagnostic", {
        **ANCHOR_DIAG,
        "InpUseTruePostAnchorBreakPullback": "true",
        "InpPostAnchorPullbackMode": "1",
        "InpPostAnchorRequireM5Reconfirm": "false",
    }),
    ("anchor_pullback_required", "anchor_flip_true_pullback_required", {
        **ANCHOR_DIAG,
        "InpM15SwingAnchorMode": "4",
        "InpUseTruePostAnchorBreakPullback": "true",
    ...
    ("anchor_pullback_m5_reconfirm", "anchor_flip_true_pullback_m5_reconfirm", {
        **ANCHOR_DIAG,
        "InpM15SwingAnchorMode": "4",
        "InpUseTruePostAnchorBreakPullback": "true",
        "InpPostAnchorPullbackMode": "3",
    ...
    ("light_or_anchor_pullback", "required_light_OR_anchor_true_pullback", {
        **ANCHOR_OR,
        "InpUseTruePostAnchorBreakPullback": "true",
        "InpPostAnchorPullbackMode": "3",
        "InpPostAnchorRequireM5Reconfirm": "false",
    }),
    ("light_or_anchor_pullback_m5pattern", "required_light_OR_anchor_true_pullback_m5pattern", {
        **ANCHOR_OR,
        "InpUseTruePostAnchorBreakPullback": "true",
        "InpPostAnchorPullbackMode": "3",
        "InpPostAnchorRequireM5Reconfirm": "false",
    ...
    ("light_or_anchor_pullback_exhaustion", "required_light_OR_anchor_true_pullback_exhaustion", {
        **ANCHOR_OR,
        "InpUseTruePostAnchorBreakPullback": "true",
        "InpPostAnchorPullbackMode": "3",
        "InpPostAnchorRequireM5Reconfirm": "false",
    ...
    ("one_anchor_pullback", "one_symbol_anchor_true_pullback", {
        **ANCHOR_DIAG,
        "InpScenarioMode": "1",
        "InpM15SwingAnchorMode": "4",
        "InpUseTruePostAnchorBreakPullback": "true",
    ...
    ("one_light_or_anchor_pullback", "one_symbol_required_light_OR_anchor_true_pullback", {
        **ANCHOR_OR,
        "InpScenarioMode": "1",
        "InpUseTruePostAnchorBreakPullback": "true",
        "InpPostAnchorPullbackMode": "3",
...
def inputs_for(run, magic):
    ...
    values["InpLogFolder"] = f"fx_session_reversal_m15_anchor_first_break_{run[0]}"
...
def tester_ini(run, preset_name):
    ...
    report_path = f"MQL5\\Experts\\dev\\reports\\backtest\\{EA_NAME}_anchor_first_{run_id}_report.html"
    return "\n".join([
        "; M15 swing anchor first-break and true post-flip pullback validation.",
        "",
        "[Experts]",
        "Enabled=0",
        "AllowLiveTrading=0",
...
def main():
    ...
    for index, run in enumerate(build_runs(args.phase), start=1):
        ...
        magic = 202607101200 + index
        preset_name = f"{EA_NAME}_anchor_first_{run_id}.set"
        ini_name = f"{EA_NAME}_anchor_first_{run_id}.ini"
        ...
        for key in [
            ...
            "InpM15AnchorRangeMode", "InpUseTruePostAnchorBreakPullback", "InpPostAnchorPullbackMode",
            "InpPostAnchorPullbackTF", "InpPostAnchorPullbackMaxBars", "InpPostAnchorPullbackMinBars",
            "InpPostAnchorRetestMaxDistanceAtr", "InpPostAnchorAllowCloseBackInsideAtr",
            "InpPostAnchorRequireM5Reconfirm", "InpExitMode", "InpMaxHoldBars",
        ]:
            row[key] = values[key]
        rows.append(row)
